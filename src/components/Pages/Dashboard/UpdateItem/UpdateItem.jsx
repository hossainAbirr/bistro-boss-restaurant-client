            ...
            <div className="my-16 p-16 bg-[#F3F3F3]">
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                    <div className="form-control w-full ">
                        ...
                        <input type="text" defaultValue={item.name} {...register('name')} placeholder="Type here" className="input input-bordered w-full" />
                    </div>
                    <div className="form-control w-full gap-6 flex-row">
                        ...
                        <div className="flex-1">
                            ...
                            <input type="text" defaultValue={item.price} {...register('price')} placeholder="Type here" className="input input-bordered w-full" />
                        </div>
                    </div>
                    ...
                    <div className="form-control">
                        ...
                        <textarea defaultValue={item.recipe} {...register('details')} className="textarea textarea-bordered h-24" placeholder="Food Reciepe"></textarea>
                    </div>
                    <div className="mb-5">
